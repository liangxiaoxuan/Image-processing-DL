...
corruption_tuple = (gaussian_noise,fog,snow,brightness,contrast,defocus_blur,elastic_transform,frost,glass_blur,
                    impulse_noise, jpeg_compression,motion_blur,pixelate, shot_noise,zoom_blur )
